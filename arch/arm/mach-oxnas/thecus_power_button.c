...
MODULE_DESCRIPTION("Thecus N0204/N2200 MB Driver for board power button operation");
MODULE_LICENSE("GPL");

#ifdef GPIO_N0204_POWER_ON_BTN
#if (GPIO_N0204_POWER_ON_BTN < 32)
#define SWITCH_NUM          GPIO_N0204_POWER_ON_BTN
...
#else
#define SWITCH_NUM          ((GPIO_N0204_POWER_ON_BTN) - 32)
...
#ifdef GPIO_N2200_POWER_ON_BTN
#if (GPIO_N2200_POWER_ON_BTN < 32)
#define SWITCH_NUM          GPIO_N2200_POWER_ON_BTN
#define IRQ_NUM             GPIO_1_INTERRUPT
#define INT_STATUS_REG      GPIO_A_INTERRUPT_STATUS_REGISTER
#define SWITCH_PRISEL_REG   SYS_CTRL_GPIO_PRIMSEL_CTRL_0
#define SWITCH_SECSEL_REG   SYS_CTRL_GPIO_SECSEL_CTRL_0
...
#define DATA_REG            GPIO_A_DATA
#else
#define SWITCH_NUM          ((GPIO_N2200_POWER_ON_BTN) - 32)
#define IRQ_NUM             GPIO_2_INTERRUPT
#define INT_STATUS_REG      GPIO_B_INTERRUPT_STATUS_REGISTER
#define SWITCH_PRISEL_REG   SYS_CTRL_GPIO_PRIMSEL_CTRL_1
#define SWITCH_SECSEL_REG   SYS_CTRL_GPIO_SECSEL_CTRL_1
...
static int __init power_button_init(void)
{
	...
	printk(KERN_INFO "Thecus Power button driver registered\n");
	return 0;
}
