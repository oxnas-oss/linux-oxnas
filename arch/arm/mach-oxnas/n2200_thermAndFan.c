...
MODULE_PARM_DESC(fan_pulse_per_rev,"Specify the number of pulses per revolution of fan - 1 or 2(default)");
...
/*
    ...
    while (i < 5) {
        ...
        temperature += Convert2C(thermostat->temps);
        curr_rpm += thermostat->curr_speed;
        i++;
    }
    temperature /= 5;
    curr_rpm /= 5;
