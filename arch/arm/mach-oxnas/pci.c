...
//	printk(KERN_DEBUG "PCI: oxnas_pci_preinit\n");
	...
	*((volatile unsigned long*)GPIO_A_FALLING_EDGE_ACTIVE_LOW_ENABLE) |= (1UL <<  PCI_GPIO_INTA_MINIPCI);
	*((volatile unsigned long*)GPIO_A_LEVEL_INTERRUPT_ENABLE) |= (1UL <<  PCI_GPIO_INTA_MINIPCI);
